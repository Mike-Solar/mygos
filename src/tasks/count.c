...
task_count30()
{
    ...
    while(1)
    {
        ...
        else printk("Task Count 30: Loop %d\n", ++loop_count);

        task_delay(DELAY);
    }

    printk("Task Count 30: Finished!\n");
}
...
task_count50()
{
    ...
    while(1)
    {
        ...
        else printk("Task Count 50: Loop %d\n", ++loop_count);

        task_delay(DELAY);
    }

    printk("Task Count 50: Finished!\n");
}
...
task_count70()
{
    ...
    while(1)
    {
        ...
        else printk("Task Count 70: Loop %d\n", ++loop_count);

        task_delay(DELAY);
    }

    printk("Task Count 70: Finished!\n");
}
